...
const otazky = [
  {
    otazka: "Obáváte se, že se ve stáří budete hůř pohybovat a nedokážete si sami dojít, kam potřebujete?",
    odpovedi: [
      "již to zažívám",
      "určitě ano",
      "spíše ano",
  ...
  {
    otazka: "Obáváte se, že budete ve stáří vystaveni šikaně nebo domácímu násilí?",
    odpovedi: [
        "již to zažívám",
        "určitě ano",
        "spíše ano",
  ...
  {
    otazka: "Plánujete využívat v důchodovém věku pro financování svých životních potřeb penzijní připojištění?",
    odpovedi: [
  ...
  {
    otazka: "Plánujete využívat v důchodovém věku pro financování svých životních potřeb zaměstnání či podnikání?",
    odpovedi: [
        "ano, jako hlavní zdroj",
        "ano, jako důležitý zdroj",
        "ano, jako okrajový zdroj",
  ...
  {
    otazka: "Jak často pomáháte sousedům či známým? Například a zahradě, při opravách nemovitostí, s nákupy nebo jako doprovod při různých pochůzkách...",
    odpovedi: [
        "denně",
        "několikrát týdně",
        "několikrát za měsíc",
  ...
  {
    otazka: "Jak často se účastníte aktivit v zájmových organizacích, například v církvi, v klubu důchodců nebo v politickém hnutí?",
    odpovedi: [
        "denně",
        "několikrát týdně",
        "několikrát za měsíc",
...
const App = () => {
  ...
  if (otazka < otazky.length) {
    ...
    return <div>Vyhodnocení, woe</div>;
  }
};
